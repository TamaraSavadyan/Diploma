...
'''
def get_data(csv_file, name_pos, net_names_pos, lat_pos, lon_pos):
       names, net_names, lat, lon = [], [], [], []
       with open(csv_file, 'r') as file:
           csv_reader = reader(file)
           for row in csv_reader:
               if row[name_pos] and row[net_names_pos] and row[lat_pos] and row[lon_pos]:
...
def main():
   ...
   plot_stuff(lon_x, lat_y, station_names_sorted, net_names_sorted)
